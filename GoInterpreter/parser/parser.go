...
func New(l *lexer.Lexer) *Parser {
	...
	p.registerInfix(token.LBRACKET, p.parseIndexExpession)

	// Read two takens, so currToken and peekToken are both set
	p.nextToken()
	p.nextToken()
...
func (p *Parser) parseIndexExpession(left ast.Expression) ast.Expression {
